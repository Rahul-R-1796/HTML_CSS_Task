// Replace this 'data' variable with your actual JSON data
const jsonData = [
  {
    "id": "1",
    "name": "Lura Senger",
...
const totalPages = Math.ceil(jsonData.length / itemsPerPage); // Calculate total number of pages

const paginationContainer = document.getElementById('pagination-container');

// Loop to create pagination elements
for (let i = 1; i <= totalPages; i++) {
  const pageLink = document.createElement('a');
  pageLink.textContent = i;
  pageLink.classList.add('page-link');
  pageLink.href = '#'; // Set href to '#' for demonstration purposes
...
// Function to show items for a given page number
function showPage(pageNumber) {
  ...
  // Create and append item elements to display
